...
<div class="interactive-wrapper atmosphere" style="--scroll-icon-color: {colour}">
      ...
      {#if videos.length > 0}
          <Videos {videos} {active} {scrollToNextBlock} {colour} />
      {/if}
          ...
          <div class="block text" style="margin-top:100vh;margin-bottom:100vh;"  data-id="2">
              ...
              <div class="block-inner">
                  ...
                  <div class="text body">
                      ...
                      <img src="__assetsPath__/oceans-locator.png" class="locator"/>
